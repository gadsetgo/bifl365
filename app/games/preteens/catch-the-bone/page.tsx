...
export default function CatchTheBonePage() {
  return (
    <main className="min-h-screen bg-charcoal">
      ...
      <div className="bg-white border-b border-gray-200 py-4 px-4">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">50 levels of fluffy dog fun 🦴</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center min-h-[calc(100vh-120px)] py-8">
        <iframe
          src="/games/preteens/catch-the-bone.html"
      ...
      <div className="bg-gray-100 py-4 px-4 text-center">
        <p className="text-gray-600 text-sm">
          ⬅ ➡ Arrow keys to move • Catch bones to earn diamonds • Perfect centre = bonus! • 50 levels of fun
        </p>
      </div>
    </main>
  );
